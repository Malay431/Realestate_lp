...
const Navbar = () => {
  ...
  return (
    <div className='absolute top-0 left-0 w-full z-10'>
      <div className='container flex justify-between items-center bg-transparent mx-auto py-4 px-6 md:px-20 lg:px-32'>
        {/* Main Image */}
        {/* <img src={assets.logo_homeies} alt='Homeies' className='h-20 w-30'/> */}
        {/*I added this, don't know why :) */}
        <div className='flex gap-2 border rounded-3xl p-5'>
          <FaHome className='h-10 w-10'/>
          <h3 className='text-2xl mt-2'><a href=''>Homeies</a></h3>
        </div>
        ...
        <button className='hidden md:block bg-white px-8 py-2 border rounded-full'>Signup</button>
